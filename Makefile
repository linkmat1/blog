...
.PHONY: entity
entity: ../linkmod/vendor/autoload.php ## CRee une Entity
	php bin/console make:entity

.PHONY: install
install: public/assets ../linkmod/vendor/autoload.php ## Installe les différentes dépendances
...
.PHONY: crud
crud: ../linkmod/vendor/autoload.php ## Cree un Crud pour une classe
	php bin/console make:crud

.PHONY: controller
controller: ../linkmod/vendor/autoload.php ## Cree un controller
	php bin/console make:controller

.PHONY: migration
migration: ../linkmod/vendor/autoload.php # Cree un migration
	$(dexec) php php bin/console make:migration

.PHONY: migrate
migrate: ../linkmod/vendor/autoload.php ## Migre la base de donnée
	$(dexec) php php bin/console doctrine:migrations:migrate -q

.PHONY: test
test: ../linkmod/vendor/autoload.php ## Execute les testsi
	$(drtest) phptest vendor/bin/phpunit

.PHONY: dev
dev: ../linkmod/vendor/autoload.php node_modules/time ## Lance le serveur de développement
	$(dc) up

.PHONY: lint
lint: ../linkmod/vendor/autoload.php ## Lint mon code !
	docker run -v $(PWD):/app --rm phpstan/phpstan analyse

.PHONY: tt
tt: ../linkmod/vendor/autoload.php ## Lance le Watcher de Tests
	$(drtest) phptest vendor/bin/phpunit-watcher watch --filter="nothing" #/vendor/bin/phpunit-watcher watch


.PHONY: seed
seed: ../linkmod/vendor/autoload.php ## Génère des données
	$(dexec) php bash -c "php bin/console doctrine:fixtures:load  -q"

.PHONY: clear ## Nettoie les containers
clear: ../linkmod/vendor/autoload.php
	$(sy) cache:clear
...
vendor/autoload.php: ../linkmod/composer.lock # installation
	$(dr) --no-deps php composer install
	touch vendor/autoload.php

node_modules/time: ../linkmod/yarn.lock
...
.PHONY: phpcs
phpcs: ../linkmod/vendor/autoload.php ## Nettoie les code  en direct!
